...
# original resolution
img=mpimg.imread('moon_rider.jpg')
...
# the none zero elements in sigma of each red, green and blue matrices
...
print(" The lower resolution of sigma 30")
#higher resolution of sigma 200
image_svd(200)

print(" The higher resolution of sigma 200")